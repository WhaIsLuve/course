	...
	: IDepartmentService
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		var department = await _departmentRepository.GetByIdAsync(id, cancellationToken) ??
		                 throw new InvalidOperationException("Не найден департамент");
	...
	public async Task AttachLocation(Guid departmentId, Guid locationId, CancellationToken cancellationToken = default)
	{
		...
		var location = await _locationRepository.GetByIdAsync(locationId, cancellationToken) ??
		               throw new InvalidOperationException("Не найдена локация");
		...
		{
			throw new InvalidOperationException("Связь между локацией и департаментов уже существует.");
		}
		...
		{
			throw new InvalidOperationException(departmentLocation.Error);
		}
	...
	public async Task DetachLocation(Guid departmentId, Guid locationId, CancellationToken cancellationToken = default)
	{
		...
		var departmentLocation =
			...
			throw new InvalidOperationException("Связи между локацией и департаментов не существует.");
